...
namespace MatrixCreator_update {
    ...
    namespace internal {
        ...
        template <typename DH>
        inline IteratorRange<DH>:: IteratorRange (const active_cell_iterator & first, const active_cell_iterator & second)
            :
            first (first),
            second (second)
        {}
        ...
        template <typename DH>
        inline IteratorRange<DH>::IteratorRange (const iterator_pair & ip)
            : first (ip.first),
              second (ip.second)
        {}
        ...
        namespace AssemblerData {
            template <int dim,
                      int spacedim>
            struct Scratch {
                Scratch (const ::std::hp::FECollection<dim, spacedim> &fe,
                         const UpdateFlags update_flags,
                         const Function<spacedim> *coefficient,
                         const Function<spacedim> *rhs_function,
                         const ::std::hp::QCollection<dim> &quadrature,
                         const ::std::hp::MappingCollection<dim, spacedim> &mapping)
                    :
                    fe_collection (fe),
                    quadrature_collection (quadrature),
                    mapping_collection (mapping),
                    x_fe_values (mapping_collection, fe_collection, quadrature_collection, update_flags),
                    coefficient_values(quadrature_collection.max_n_quadrature_points()),
                    coefficient_vector_values (quadrature_collection.max_n_quadrature_points(), std::Vector<double> (fe_collection.n_components())),
                    rhs_values(quadrature_collection.max_n_quadrature_points()),
                    rhs_vector_values(quadrature_collection.max_n_quadrature_points(), std::Vector<double> (fe_collection.n_components())),
                ...
                Scratch (const Scratch & data)
                    ...
                    x_fe_values (mapping_collection, fe_collection, quadrature_collection, data.update_flags),
                ...
                const ::std::hp::FECollection<dim, spacedim>      &fe_collection;
                const ::std::hp::QCollection<dim>                &quadrature_collection;
                const ::std::hp::MappingCollection<dim, spacedim> &mapping_collection;

                ::std::hp::FEValues<dim, spacedim> x_fe_values;

                std::vector<double>                  coefficient_values;
                std::vector<std::Vector<double>> coefficient_vector_values;
                std::vector<double>                  rhs_values;
                std::vector<std::Vector<double>> rhs_vector_values;
        ...
        void advection_assembler (const CellIterator & cell, MatrixCreator_update::internal::AssemblerData::Scratch<dim, spacedim> &data, MatrixCreator_update::internal::AssemblerData::CopyData & copy_data) {
            ...
            Assert(data.rhs_function == 0 ||
                   ...
                   ::std::MatrixCreator_update::ExcComponentMismatch());
            ...
            for (unsigned int i = 0; i < dofs_per_cell; ++i)
                if (fe.is_primitive ()) {
                    ...
                    // use symmetry in the advection matrix here:
        ...
        template <int dim, int spacedim, typename CellIterator>
        void laplace_assembler (const CellIterator & cell, MatrixCreator_update::internal::AssemblerData::Scratch<dim, spacedim> &data, MatrixCreator_update::internal::AssemblerData::CopyData & copy_data) {
        ...
        void copy_local_to_global (const AssemblerData::CopyData & data, MatrixType * matrix, VectorType * right_hand_side) {
            ...
            Assert ((right_hand_side == 0) || (data.cell_rhs.size() == dofs_per_cell), ExcInternalError());

            if (right_hand_side != 0) {
                data.constraints->
                distribute_local_to_global(data.cell_matrix, data.cell_rhs, data.dof_indices, *matrix, *right_hand_side);
            } else {
                data.constraints->
                distribute_local_to_global(data.cell_matrix, data.dof_indices, *matrix);
            }
        }
...
namespace MatrixCreator_update {
    ...
    void create_advection_matrix (const Mapping<dim, spacedim>       &mapping,
        ...
        MatrixCreator_update::internal::AssemblerData::Scratch<dim, spacedim>
        ...
        MatrixCreator_update::internal::AssemblerData::CopyData copy_data;
        ...
        WorkStream::run (dof.begin_active(),
                         ...
                         &MatrixCreator_update::internal::advection_assembler<dim, spacedim, typename DoFHandler<dim, spacedim>::active_cell_iterator>,
                         std_cxx11::bind (&MatrixCreator_update::internal::
    ...
    void create_advection_matrix (const DoFHandler<dim, spacedim>    &dof,
                                  ...
                                  const Function<spacedim> *const coefficient,
                                  const ConstraintMatrix   &constraints) {
        create_advection_matrix(StaticMappingQ1<dim, spacedim>::mapping, dof,
    ...
    void create_advection_matrix (const DoFHandler<dim, spacedim>    &dof,
                                  ...
                                  const Function<spacedim> *const coefficient,
                                  const ConstraintMatrix   &constraints) {
        create_advection_matrix(StaticMappingQ1<dim, spacedim>::mapping,
    ...
    void create_advection_matrix (const hp::MappingCollection<dim, spacedim> &mapping,
        ...
        WorkStream::run (dof.begin_active(),
                         ...
                         &MatrixCreator_update::internal::advection_assembler<dim, spacedim, typename hp::DoFHandler<dim, spacedim>::active_cell_iterator>,
                         std_cxx11::bind (&MatrixCreator_update::internal::
                                          copy_local_to_global<SparseMatrix<number>, Vector<double>>,
                                          std_cxx11::_1, &matrix, (Vector<double> *)0),
                         assembler_data,
    ...
    void create_advection_matrix (const hp::DoFHandler<dim, spacedim> &dof,
                                  ...
                                  const Function<spacedim> *const coefficient,
                                  const ConstraintMatrix   &constraints) {
        create_advection_matrix(hp::StaticMappingQ1<dim, spacedim>::mapping_collection, dof, q, matrix, coefficient, constraints);
    }
    ...
    void create_advection_matrix (const hp::DoFHandler<dim, spacedim> &dof,
                                  ...
                                  const Function<spacedim> *const coefficient,
                                  const ConstraintMatrix   &constraints) {
        create_advection_matrix(hp::StaticMappingQ1<dim, spacedim>::mapping_collection, dof, q,
    ...
    namespace {
        ...
        void create_boundary_advection_matrix_1 (typename DoFHandler<dim, spacedim>::active_cell_iterator const &cell,
                MatrixCreator_update::internal::AssemblerBoundary::Scratch const &scratch,
                MatrixCreator_update::internal::AssemblerBoundary::CopyData<DoFHandler<dim,
                spacedim>> &copy_data,
        ...
        template <int dim, int spacedim>
        void copy_boundary_advection_matrix_1(MatrixCreator_update::internal::AssemblerBoundary::CopyData<DoFHandler<dim,
        ...
        template <>
        void create_boundary_advection_matrix_1<1, 3> (DoFHandler<1, 3>::active_cell_iterator const &cell,
                MatrixCreator_update::internal::AssemblerBoundary::Scratch const
                &scratch,
                MatrixCreator_update::internal::AssemblerBoundary::CopyData<DoFHandler<1,
                3>> &copy_data,
    ...
    template <int dim, int spacedim>
    void create_boundary_advection_matrix (const Mapping<dim, spacedim>  &mapping,
                                           const DoFHandler<dim, spacedim> &dof,
        ...
        MatrixCreator_update::internal::AssemblerBoundary::Scratch scratch;
        MatrixCreator_update::internal::AssemblerBoundary::CopyData<DoFHandler<dim, spacedim>> copy_data;
        ...
        WorkStream::run(dof.begin_active(), dof.end(),
                        static_cast<std_cxx11::function<void (typename DoFHandler<dim, spacedim>::active_cell_iterator
                                const &, MatrixCreator_update::internal::AssemblerBoundary::Scratch const &,
                                MatrixCreator_update::internal::AssemblerBoundary::CopyData<DoFHandler<dim, spacedim>> &)>>
                        (std_cxx11::bind(&create_boundary_advection_matrix_1<dim, spacedim>, std_cxx11::_1, std_cxx11::_2,
                                         std_cxx11::_3,
                        ...
                        static_cast<std_cxx11::function<void (MatrixCreator_update::internal::AssemblerBoundary
                                ::CopyData<DoFHandler<dim, spacedim>> const &)>> (std_cxx11::bind(
                                            &copy_boundary_advection_matrix_1<dim, spacedim>,
                                            std_cxx11::_1,
    ...
    namespace {
        ...
        template <int dim, int spacedim>
        void
        create_hp_boundary_advection_matrix_1 (typename hp::DoFHandler<dim, spacedim>::active_cell_iterator const
                                               &cell,
                                               MatrixCreator_update::internal::AssemblerBoundary::Scratch const &scratch,
                                               MatrixCreator_update::internal::AssemblerBoundary
        ...
        template <int dim, int spacedim>
        void copy_hp_boundary_advection_matrix_1(MatrixCreator_update::internal::AssemblerBoundary
                    ...
                    for (unsigned int i = 0; i < copy_data.dofs_per_cell; ++i)
                        for (unsigned int j = 0; j < copy_data.dofs_per_cell; ++j) {
                            if (copy_data.dof_is_on_face[pos][i] && copy_data.dof_is_on_face[pos][j])
                                ...
                                // is not the case, then the boundary advection matrix does not
    ...
    template <int dim, int spacedim>
    void create_boundary_advection_matrix (const DoFHandler<dim, spacedim>     &dof,
                                           const Quadrature < dim - 1 >   &q,
                                           SparseMatrix<double>      &matrix,
                                           ...
                                           std::vector<unsigned int> component_mapping) {
        create_boundary_advection_matrix(StaticMappingQ1<dim, spacedim>::mapping, dof, q,
    ...
    template <int dim, int spacedim>
    void
    create_boundary_advection_matrix (const hp::MappingCollection<dim, spacedim>        &mapping,
                                      const hp::DoFHandler<dim, spacedim>     &dof,
        ...
        MatrixCreator_update::internal::AssemblerBoundary::Scratch scratch;
        MatrixCreator_update::internal::AssemblerBoundary::CopyData<hp::DoFHandler<dim, spacedim>> copy_data;

        WorkStream::run(dof.begin_active(), dof.end(),
                        static_cast<std_cxx11::function<void (typename hp::DoFHandler<dim, spacedim>::active_cell_iterator
                                const &, MatrixCreator_update::internal::AssemblerBoundary::Scratch const &,
                                MatrixCreator_update::internal::AssemblerBoundary::CopyData<hp::DoFHandler<dim, spacedim>> &)>>
                        (std_cxx11::bind( &create_hp_boundary_advection_matrix_1<dim, spacedim>, std_cxx11::_1, std_cxx11::_2,
                                          std_cxx11::_3,
                        ...
                        static_cast<std_cxx11::function<void (MatrixCreator_update::internal::AssemblerBoundary
                            ...
                            std_cxx11::bind( &copy_hp_boundary_advection_matrix_1<dim, spacedim>,
                                             std_cxx11::_1,
                                             std_cxx11::cref(boundary_functions),
                                             std_cxx11::cref(dof_to_boundary_mapping),
                                             std_cxx11::ref(matrix),
    ...
    template <int dim, int spacedim>
    void create_boundary_advection_matrix (const hp::DoFHandler<dim, spacedim>     &dof,
                                           const hp::QCollection < dim - 1 >   &q,
                                           SparseMatrix<double>      &matrix,
                                           const typename FunctionMap<spacedim>::type &rhs,
                                           Vector<double>            &rhs_vector,
                                           ...
                                           const Function<spacedim> *const a,
                                           std::vector<unsigned int> component_mapping) {
        create_boundary_advection_matrix(hp::StaticMappingQ1<dim, spacedim>::mapping_collection, dof, q,
                                         matrix, rhs, rhs_vector, dof_to_boundary_mapping, a, component_mapping);
    }
    ...
    void create_laplace_matrix (const Mapping<dim, spacedim>       &mapping,
        ...
        WorkStream::run (dof.begin_active(),
                         static_cast<typename DoFHandler<dim, spacedim>::active_cell_iterator>(dof.end()),
                         &MatrixCreator_update::internal::laplace_assembler<dim, spacedim, typename DoFHandler<dim, spacedim>::active_cell_iterator>,
                         std_cxx11::bind (&MatrixCreator_update::internal::
    ...
    void create_laplace_matrix (const hp::MappingCollection<dim, spacedim>       &mapping,
        ...
        WorkStream::run (dof.begin_active(),
                         static_cast<typename hp::DoFHandler<dim, spacedim>::active_cell_iterator>(dof.end()),
                         &MatrixCreator_update::internal::laplace_assembler<dim, spacedim, typename hp::DoFHandler<dim, spacedim>::active_cell_iterator>,
                         std_cxx11::bind (&MatrixCreator_update::internal::
                                          copy_local_to_global<SparseMatrix<double>, Vector<double>>,
                                          std_cxx11::_1,
                                          &matrix,
...
namespace MatrixTools {
    ...
    apply_boundary_values (const std::map<types::global_dof_index, double>  &boundary_values,
        ...
        std::vector<std::map<std::types::global_dof_index, double>> block_boundary_values(n_blocks);
        {
            int block = 0;
            std::types::global_dof_index offset = 0;
            for (std::map<types::global_dof_index, double>::const_iterator
                    dof  = boundary_values.begin();
                    dof != boundary_values.end();
                    ++dof) {
